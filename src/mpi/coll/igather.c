                       ...
                       MPIR_Sched_t s)
{
    ...
    mpi_errno =
        MPIR_Igather_binomial(sendbuf, sendcount, sendtype, recvbuf, recvcount, recvtype, root,
                              comm_ptr, s);
    if (mpi_errno)
        MPIR_ERR_POP(mpi_errno);
                      ...
                      MPI_Request * request)
{
    ...
    *request = MPI_REQUEST_NULL;
    ...
    mpi_errno =
        comm_ptr->coll_fns->Igather_sched(sendbuf, sendcount, sendtype, recvbuf, recvcount,
